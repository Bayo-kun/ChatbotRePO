...
st.sidebar.image('pngwing.com (2).png', caption = 'Welcome User > _ < ')
...
st.markdown("<h1 style = 'color: #FEFBF6; ; text-align: center; font-family: Courier'>ORGANISATIONAL CHATBOT</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #FEFBF6; ; text-align: center; font-family: Courier '>Built By Gomycode Data Science Daintree</h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('pngwing.com (7).png', caption = 'I reply all your questions')
